...
@Component({
    ...
    <div class="min-h-screen bg-gray-50 pt-32 pb-20 font-sans" dir="rtl">
      <div class="container mx-auto px-4 max-w-5xl">
        ...
        <!-- Welcome Header -->
        <div class="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm mb-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div class="flex items-center gap-6">
            <div class="w-20 h-20 bg-gray-100 rounded-2xl flex items-center justify-center text-black">
            ...
            <div>
              <h1 class="text-2xl font-black text-black mb-1">مرحباً، {{ authService.currentUser()?.firstName }}</h1>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-1 space-y-6">
            <div class="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm">
              ...
              @if (authService.currentUser()?.address) {
                <div class="space-y-2 text-gray-600 text-sm">
                  <p class="font-bold text-black">{{ authService.currentUser()?.firstName }} {{ authService.currentUser()?.lastName }}</p>
            ...
            <div class="bg-black text-white rounded-3xl p-6 shadow-lg relative overflow-hidden group">
               ...
               <a routerLink="/contact" class="inline-flex items-center gap-2 text-sm font-bold bg-white text-black px-4 py-2 rounded-lg relative z-10">
                 تواصل معنا
               </a>
            </div>
          </div>
          ...
          <div class="lg:col-span-2">
            <div class="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
               <div class="p-6 border-b border-gray-200 flex items-center justify-between">
                  <h3 class="text-xl font-black text-black">طلباتك السابقة</h3>
               ...
               @if (loadingOrders()) {
                 ...
                 <div class="p-20 text-center">
                    ...
                    <h4 class="text-lg font-bold text-black mb-2">لا توجد طلبات بعد</h4>
                    <p class="text-gray-500 mb-6 text-sm">ابدأ التسوق الآن واكتشف منتجاتنا المميزة.</p>
                    <a routerLink="/products" class="inline-flex items-center justify-center bg-black text-white font-bold py-3 px-8 rounded-xl hover:bg-gray-800 transition-all">تسوق الآن</a>
                 </div>
               } @else {
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-4 mb-4">
                          <div class="flex items-center gap-4">
                            <div class="bg-gray-100 px-4 py-2 rounded-xl text-center">
                              ...
                              <span class="text-black font-black">#{{ order.orderNumber }}</span>
                            </div>
                            <div>
                          ...
                          <div class="text-left">
                             ...
                             <p class="text-xl font-black text-black">{{ currencyService.formatPrice(order.totalPrice.amount) }}</p>
                          </div>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-3">
                           @for (item of order.lineItems.edges; track item.node.title) {
                             <div class="flex items-center gap-2 bg-gray-50 p-2 rounded-lg border border-gray-100">
                                ...
                                <div class="text-[10px]">
                                   <p class="text-black font-bold line-clamp-1 max-w-[150px]">{{ item.node.title }}</p>
